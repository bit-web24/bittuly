    ...
    <AppLayout title="Insights">
      <div className="mx-auto max-w-5xl space-y-6">
        ...
        <div className="flex items-start gap-2.5 rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800 dark:border-amber-800 dark:bg-amber-950/40 dark:text-amber-300">
          ...
          <p>
            <span className="font-semibold">Counts may be slightly stale.</span>{" "}
            Clicks are recorded in batches and written to the database every 17 events — recent
            activity might not be reflected here yet.
          </p>
        </div>
