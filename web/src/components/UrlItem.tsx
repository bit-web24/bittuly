    ...
    <Dialog open={detailsOpen} onOpenChange={setDetailsOpen}>
      <TooltipProvider>
        ...
        >
          ...
          {formattedExpiry && (
            <div
              className={`flex shrink-0 items-center gap-1.5 text-xs mr-2 ${isExpired ? "text-destructive font-medium" : "text-muted-foreground"}`}
            >
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    ...
                    <strong>bittuly.com/{url.short_code}</strong>) and remove
                    all its click analytics. This action cannot be undone.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
        ...
        <DialogContent className="sm:max-w-xl" showCloseButton={false}>
          ...
          <div className="space-y-6 py-4">
            <div className="space-y-1.5">
              ...
              <p className="text-sm break-all bg-muted/50 p-3 rounded-md">
                {url.original_url}
              </p>
            </div>
            <div className="space-y-1.5">
            ...
            {formattedExpiry && (
              <div className="space-y-1 border-t pt-4">
                ...
                <div className="flex items-center gap-2 mt-1">
                  <span
                    className={`inline-flex items-center rounded-full px-2 py-0.5 text-xs font-semibold ${isExpired ? "bg-destructive/10 text-destructive" : "bg-green-100 text-green-800"}`}
                  >
